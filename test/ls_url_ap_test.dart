...
void main() {
  ...
  test('LS URL generation - AP dictionary full test', () async {
    final db =
        await openDbFromZip('ap_lslinks.sqlite', 'ap_lslinks.sqlite.zip');
    ...
    for (final row in result) {
      ...
      final generatedUrl =
          LsService.generateHref('ap', key ?? '', nAttr, lsContent);
