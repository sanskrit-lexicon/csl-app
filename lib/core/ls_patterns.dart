...
class LsPatterns {
  ...
  static final List<LsPattern> mw = [
    ...
    LsPattern(
      ...
      regex:
          r'^(Ragh[.] ed[.] Calc[.]|Ragh[.] \(C\)|Raghuv[.]) *([0-9ivxlcmIVXLCM]+), *([0-9]+), *([0-9]+)',
      urlTemplate:
    ...
    LsPattern(
      ...
      regex:
          r'^(Kum[.]|Kumāras[.]) *([0-9]+|[ivxlIVXL]+), *([0-9]+), *([0-9]+)',
      urlTemplate:
    ...
    LsPattern(
      ...
      regex:
          r'^(R\. \(B\.\)|R\. B\.|R\. \[B\.\]|R\. \[B\]) *([0-9ivxlcmIVXLCM]+)[ ,]+([0-9]+)[ ,]+([0-9]+)(.*)$',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/ramayanabom/app1/?\$2,\$3,\$4',
    ),
    ...
    LsPattern(
      prefixes: ['TBr.'],
      regex:
          r'^(TBr[.]) *([0-9]+|[ivxlIVXL]+), *([0-9]+), *([0-9]+), *([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/taittiriyabr/app1?\$2,\$3,\$4,\$5',
    ),
    LsPattern(
    ...
    LsPattern(
      ...
      regex:
          r'^(KātyŚr\.|Kāty\. Śr\.) *([0-9]+|[ivxlIVXL]+), *([0-9]+), *([0-9]+)[.]?',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/katyasr/app1?\$2,\$3,\$4',
    ),
    LsPattern(
    ...
    LsPattern(
      ...
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/bohtlingk_mw/app1?\$2',
    ),
    // Amara Kosha
    LsPattern(
      prefixes: ['AK.'],
      ...
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/amarakosha/app1?\$2,\$3,\$4',
    ),
    // Hitopadesha
    LsPattern(
      prefixes: ['Hit.'],
    ...
    LsPattern(
      ...
      regex:
          r'^(Ait[.] Br[.]|AitBr[.]) *([0-9]+|[ivxlIVXL]+), *([0-9]+), *([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/aitbr_auf/app1?\$2,\$3,\$4',
    ),
    LsPattern(
    ...
    LsPattern(
      ...
      regex: r'^(MBh\.|MBH\.) *([^ ,]+) *, *([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/mbhcalc?\$2_r20.\$3',
    ),
  ];
  ...
  static final List<LsPattern> ap = [
    // R. (Raghuvamśa in AP) - 2 parameters: Kanda, Sarga
    LsPattern(
      prefixes: ['R.'],
      regex: r'^(R\.) *([0-9]+)\. +([0-9]+)',
      urlTemplate:
    ...
    // Ms. (Manu Smṛti) - 2 parameters: Adhyaya, Shloka
    LsPattern(
      prefixes: ['Ms.'],
      regex: r'^(Ms\.) +([0-9]+)\. +([0-9]+)',
      urlTemplate:
    ...
    // Bhāg. (Bhāgavata Purāṇa) - 3 parameters: Skandha, Adhyaya, Shloka
    LsPattern(
      prefixes: ['Bhāg.'],
      regex: r'^(Bhāg\.) +([0-9]+)\. +([0-9]+)\. +([0-9]+)',
      urlTemplate: 'bhagApUrl',
    ),
    // Ku. (Kumārasambhava) - 2 parameters: Sarga, Shloka
    LsPattern(
      prefixes: ['Ku.'],
      regex: r'^(Ku\.) +([0-9]+)\. +([0-9]+)',
      urlTemplate:
    ...
    // Y. (Yājñavalkya Smṛti) - 2 parameters
    LsPattern(
      prefixes: ['Y.'],
      regex: r'^(Y\.) +([0-9]+)\. +([0-9]+)',
      urlTemplate:
    ...
    LsPattern(
      ...
      regex: r'^(Ak\.) +([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/amara_dlc/app1?\$2',
    ),
    // Rāj. T. (Rājataraṅgiṇī) - 2 parameters
    LsPattern(
      prefixes: ['Rāj. T.'],
      regex: r'^(Rāj\. T\.) +([0-9]+)\. +([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/rajatar/app1?\$2,\$3',
    ),
    // Vāj. (Vājasaneyi Saṃhitā) - 2 parameters
    LsPattern(
      prefixes: ['Vāj.'],
      regex: r'^(Vāj\.) +([0-9]+)\. +([0-9]+)',
      urlTemplate:
    ...
    // Śat. Br. (Śatapatha Brāhmaṇa) - 4 parameters
    LsPattern(
      prefixes: ['Śat. Br.'],
      regex: r'^(Śat\. Br\.) +([0-9]+)\. +([0-9]+)\. +([0-9]+)\. +([0-9]+)',
      urlTemplate:
    ...
    // Ait. Br. (Aitareya Brāhmaṇa) - 2 parameters
    LsPattern(
      prefixes: ['Ait. Br.'],
      regex: r'^(Ait\. Br\.) +([0-9]+)\. +([0-9]+)',
      urlTemplate:
    ...
    // C. P. (Caurapañcāśikā) - 1 parameter
    LsPattern(
      prefixes: ['C. P.'],
      regex: r'^(C\. P\.) +([0-9]+)',
      urlTemplate:
    ...
    // Ks. (Kathāsaritsāgara) - 2 parameters
    LsPattern(
      prefixes: ['Ks.'],
      regex: r'^(Ks\.) +([0-9]+)\. +([0-9]+)',
      urlTemplate:
    ...
    // Mārk. P. (Mārkaṇḍeya Purāṇa) - 2 parameters
    LsPattern(
      prefixes: ['Mārk. P.'],
      regex: r'^(Mārk\. P\.) +([0-9]+)\. +([0-9]+)',
      urlTemplate:
    ...
    // T. Br. (Taittirīya Brāhmaṇa) - 4 parameters
    LsPattern(
      prefixes: ['T. Br.'],
      regex: r'^(T\. Br\.) +([0-9]+)\. +([0-9]+)\. +([0-9]+)\. +([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/taittiriyabr/app1?\$2,\$3,\$4,\$5',
    ),
    // Bṛ. S. (Bṛhatsaṃhitā) - 2 parameters
    LsPattern(
      prefixes: ['Bṛ. S.'],
      regex: r'^(Bṛ\. S\.) +([0-9]+)\. +([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/brihatsam/app1?\$2,\$3',
    ),
    // Ś. Til. (Śṛṅgāratilaka) - 1 parameter
    LsPattern(
      prefixes: ['Ś. Til.'],
      regex: r'^(Ś\. Til\.) +([0-9]+)',
      urlTemplate:
    ...
    // Abh. Cin. (Abhidhānacintāmaṇi) - 1 parameter
    LsPattern(
      prefixes: ['Abh. Cin.'],
      regex: r'^(Abh\. Cin\.) +([0-9]+)',
      urlTemplate: 'https://sanskrit-lexicon-scans.github.io/abch2/app1?\$2',
    ),
    // Ts. (Taittirīya Saṃhitā) - 4 parameters
    LsPattern(
      prefixes: ['Ts.'],
      regex: r'^(Ts\.) +([0-9]+)\. +([0-9]+)\. +([0-9]+)\. +([0-9]+)',
      urlTemplate:
    ...
    // Nala. (Nalopākhyāna) - 2 parameters
    LsPattern(
      prefixes: ['Nala.'],
      regex: r'^(Nala\.) +([0-9]+)\. +([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/bchrest1/app1?\$2,\$3',
    ),
  ];
  ...
  static final List<LsPattern> sch = [
    // R. ed. Bomb. specific (High priority)
    LsPattern(
      prefixes: ['R. ed. Bomb.'],
      regex:
          r'^(R\. ed\. Bomb\.)\s*([0-9ivxlcmIVXLCM]+),\s*([0-9]+),\s*([0-9]+)',
      urlTemplate: 'ramayanaBombSchUrl',
    ),
    // Bhāg. P. specific
    LsPattern(
      prefixes: ['Bhāg. P.'],
      regex: r'^(Bhāg\. P\.)\s*([0-9]+),\s*([0-9]+),\s*([0-9]+)',
      urlTemplate: 'bhagSchUrl',
    ),
    LsPattern(
      prefixes: ['Bhāg. P.'],
      regex: r'^(Bhāg\. P\.)\s*([0-9]+),\s*([0-9]+)',
      urlTemplate: 'bhagSchUrl2',
    ),
    // Panini for SCH
    LsPattern(
      prefixes: ['P.', 'Pāṇ.'],
      regex: r'^(Pāṇ\.|P\.)\s*([0-9]+),\s*([0-9]+),\s*([0-9]+)',
      urlTemplate: 'https://ashtadhyayi.com/sutraani/\$2/\$3/\$4',
    ),
    LsPattern(
      prefixes: ['P.', 'Pāṇ.'],
      regex: r'^(Pāṇ\.|P\.)\s*([0-9]+),\s*([0-9]+)',
      urlTemplate: 'https://ashtadhyayi.com/sutraani/\$2/\$3',
    ),
    // Ramayana (generic R. after ed. Bomb.)
    LsPattern(
      prefixes: ['R.'],
      regex: r'^(R\.)\s*([0-9ivxlcmIVXLCM]+),\s*([0-9]+),\s*([0-9]+)',
      urlTemplate: 'ramayanaSchUrl',
    ),
    // Mahabharata for SCH
    LsPattern(
      prefixes: ['MBh.', 'MBH.'],
      regex: r'^(MBh\.|MBH\.)\s*([0-9]+),\s*([0-9]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/mbhbomb/app1?\$2,\$3,\$4',
    ),
    LsPattern(
      prefixes: ['MBh.', 'MBH.'],
      regex: r'^(MBh\.|MBH\.)\s*([0-9]+),\s*([0-9]+)',
      urlTemplate: 'https://sanskrit-lexicon-scans.github.io/mbhcalc?\$2.\$3',
    ),
    // Subhashita for SCH
    LsPattern(
    ...
    // Bhagavata Purana (generic variants)
    LsPattern(
      prefixes: ['Bhāg.', 'BhP.'],
      regex: r'^((?:Bhāg\.|BhP\.))\s*([0-9]+),\s*([0-9]+),\s*([0-9]+)',
      urlTemplate: 'bhagSchUrl',
    ),
    LsPattern(
      prefixes: ['Bhāg.', 'BhP.'],
      regex: r'^((?:Bhāg\.|BhP\.))\s*([0-9]+),\s*([0-9]+)',
      urlTemplate: 'bhagSchUrl2',
    ),
    // Varaha Brihat Samhita
    LsPattern(
      prefixes: ['Varāh. Bṛh. S.'],
      regex:
          r'^(Varāh\. Bṛh\. S\.)\s*([0-9ivxlcmIVXLCM]+),\s*([0-9]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/brihatsam/app1?\$2,\$3,\$4',
    ),
    LsPattern(
      prefixes: ['Varāh. Bṛh. S.'],
      regex: r'^(Varāh\. Bṛh\. S\.)\s*([0-9ivxlcmIVXLCM]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/brihatsam/app1?\$2,\$3',
    ),
    LsPattern(
      ...
      regex:
          r'^(Varāh\.|VarBṛS\.)\s*([0-9ivxlcmIVXLCM]+),\s*([0-9]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/brihatsam/app1?\$2,\$3,\$4',
    ),
    // Markandeya Purana
    LsPattern(
      prefixes: ['Mārk. P.'],
      regex: r'^(Mārk\. P\.)\s*([0-9ivxlcmIVXLCM]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/markandeyapurana/app1?\$2,\$3',
    ),
    LsPattern(
      prefixes: ['Mārk.', 'MārkP.'],
      regex: r'^(Mārk\.|MārkP\.)\s*([0-9ivxlcmIVXLCM]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/markandeyapurana/app1?\$2,\$3',
    ),
    // Mn. / M. for SCH
    LsPattern(
      prefixes: ['Mn.', 'M.'],
      regex: r'^(Mn\.|M\.)\s*([0-9ivxlcmIVXLCM]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/manu/index.html?\$2,\$3',
    ),
    // Sahitya Darpana
    LsPattern(
      prefixes: ['Sāh. D.'],
      regex: r'^(Sāh\. D\.)\s*([0-9ivxlcmIVXLCM]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/sahityadarpana/app1?\$2,\$3',
    ),
    LsPattern(
      prefixes: ['Sāh. D.'],
      regex: r'^(Sāh\. D\.)\s*([0-9ivxlcmIVXLCM]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/sahityadarpana/app1?\$2',
    ),
    LsPattern(
      prefixes: ['Sāh.'],
      regex: r'^(Sāh\.)\s*([0-9ivxlcmIVXLCM]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/sahityadarpana/app1?\$2,\$3',
    ),
    LsPattern(
      prefixes: ['Sāh.'],
      regex: r'^(Sāh\.)\s*([0-9ivxlcmIVXLCM]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/sahityadarpana/app1?\$2',
    ),
    // Malavikagnimitra
    LsPattern(
      prefixes: ['Mālav.'],
      regex: r'^(Mālav\.)\s*([0-9ivxlcmIVXLCM]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/malavikagni/app2?\$2,\$3',
    ),
    LsPattern(
    ...
    // Vikramorvashiya
    LsPattern(
      prefixes: ['Vikram.', 'Vikr.'],
      regex: r'^(Vikram\.|Vikr\.)\s*([0-9ivxlcmIVXLCM]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/vikramor/app2?\$2,\$3',
    ),
    LsPattern(
      prefixes: ['Vikram.', 'Vikr.'],
      regex: r'^(Vikram\.|Vikr\.)\s*([0-9]+)',
      urlTemplate: 'https://sanskrit-lexicon-scans.github.io/vikramor/app1?\$2',
    ),
    // Vopadeva
    LsPattern(
      prefixes: ['Vop.'],
      regex: r'^(Vop\.)\s*([0-9ivxlcmIVXLCM]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/mugdhabodha/app1?\$2,\$3',
    ),
    // Halayudha
    LsPattern(
      prefixes: ['Halāy.'],
      regex: r'^(Halāy\.)\s*([0-9ivxlcmIVXLCM]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/armh2/app1?\$2,\$3',
    ),
    // Amara Kosha
    LsPattern(
      prefixes: ['AK.'],
      regex: r'^(AK\.)\s*([0-9]+),\s*([0-9]+),\s*([0-9]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/amara_dlc/app1?\$2,\$3,\$4,\$5',
    ),
    LsPattern(
      prefixes: ['AK.'],
      regex: r'^(AK\.)\s*([0-9]+),\s*([0-9]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/amara_dlc/app1?\$2,\$3,\$4',
    ),
    // Kathasaritsagara
    LsPattern(
      prefixes: ['Kathās.', 'KSS.'],
      regex: r'^(Kathās\.|KSS\.)\s*([0-9ivxlcmIVXLCM]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/kss/index.html?\$2,\$3',
    ),
    // Oxford Catalogue
    ...
    LsPattern(
      prefixes: ['TS.'],
      regex: r'^(TS\.)\s*([0-9]+),\s*([0-9]+),\s*([0-9]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/taittiriyas/app1?\$2,\$3,\$4,\$5',
    ),
    LsPattern(
      prefixes: ['TS.'],
      regex: r'^(TS\.)\s*([0-9]+),\s*([0-9]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/taittiriyas/app1?\$2,\$3,\$4',
    ),
    // Shatapatha Brahmana
    LsPattern(
      prefixes: ['Śat. Br.'],
      regex: r'^(Śat\. Br\.)\s*([0-9]+),\s*([0-9]+),\s*([0-9]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/shatapathabr/app1?\$2,\$3,\$4,\$5',
    ),
    LsPattern(
      prefixes: ['ŚBr.'],
      regex: r'^(ŚBr\.)\s*([0-9]+),\s*([0-9]+),\s*([0-9]+),\s*([0-9]+)',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/shatapathabr/app1?\$2,\$3,\$4,\$5',
    ),
    // Harivansha
    LsPattern(
      ...
      regex: r'^(H\.)\s*([0-9]+)[.]?',
      urlTemplate:
          'https://sanskrit-lexicon-scans.github.io/harivamsa/app1?\$2',
    ),
    ...
    ...mw.where((p) => ![
          ...
          'Trik.',
          'Hār.'
        ].any((pre) => p.prefixes.contains(pre))),
  ];
}
